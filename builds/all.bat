...
set "_modules=curl imgui json lazy_importer neargye.magic_enum neargye.nameof neargye.semver neargye.yacppl neargye.scope_guard nirvana phnt tinycc turbo_base64 vmp xorstr xorstr2 zlib zydis knsoft.ndk knsoft.slimdetours asmjit"
